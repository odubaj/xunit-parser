...
if [ $topic == "VirtualTopic.eng.ci.brew-build.test.complete" ] ; then
...
elif [ $topic == "VirtualTopic.eng.ci.brew-build.test.error" ] ; then
...
elif [ $topic == "VirtualTopic.eng.ci.brew-build.test.running" ] ; then
